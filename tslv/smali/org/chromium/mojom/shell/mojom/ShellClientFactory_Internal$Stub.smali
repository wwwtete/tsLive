.class final Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$Stub;
...
# direct methods
.method constructor <init>(Lorg/chromium/mojo/system/Core;Lorg/chromium/mojom/shell/mojom/ShellClientFactory;)V
    .locals 0
...
.method public accept(Lorg/chromium/mojo/bindings/Message;)Z
    ...
    .line 96
    :pswitch_1
    sget-object v4, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
    ...
    invoke-static {v4}, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;->deserialize(Lorg/chromium/mojo/bindings/Message;)Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;

    move-result-object v0

    .line 108
    .local v0, "data":Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;
    invoke-virtual {p0}, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$Stub;->getImpl()Lorg/chromium/mojo/bindings/Interface;

    move-result-object v4

    check-cast v4, Lorg/chromium/mojom/shell/mojom/ShellClientFactory;

    iget-object v6, v0, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;->shellClient:Lorg/chromium/mojo/bindings/InterfaceRequest;

    iget-object v7, v0, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;->name:Ljava/lang/String;

    invoke-interface {v4, v6, v7}, Lorg/chromium/mojom/shell/mojom/ShellClientFactory;->createShellClient(Lorg/chromium/mojo/bindings/InterfaceRequest;Ljava/lang/String;)V
    :try_end_0
    ...
    .line 116
    .end local v0    # "data":Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$ShellClientFactoryCreateShellClientParams;
    .end local v2    # "header":Lorg/chromium/mojo/bindings/MessageHeader;
    .end local v3    # "messageWithHeader":Lorg/chromium/mojo/bindings/ServiceMessage;
    :catch_0
    move-exception v1
...
.method public acceptWithResponder(Lorg/chromium/mojo/bindings/Message;Lorg/chromium/mojo/bindings/MessageReceiver;)Z
    ...
    .line 134
    :pswitch_0
    invoke-virtual {p0}, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal$Stub;->getCore()Lorg/chromium/mojo/system/Core;

    move-result-object v4

    sget-object v5, Lorg/chromium/mojom/shell/mojom/ShellClientFactory_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
